...
public class TabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabManager.addTab(R.string.lbl_master_detail, R.drawable.ico_star,MasterDetailFragment.class, savedInstanceState);
...
//            	Log.i(TAG, "Album disparou exeÃ§Ã£o = " + throwable);
//            }
//        };
//        
...
//    	});
        ...
        SimpleFacebook.getInstance().getAlbums(new OnAlbumsListener() {
			...
			@Override
			public void onException(Throwable throwable) {
				Log.i(TAG, "Album disparou exceção = ",throwable);
			}
